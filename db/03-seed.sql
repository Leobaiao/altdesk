...
INSERT INTO altdesk.Tenant (TenantId, Name) VALUES (@tenant, 'Tenant Dev');
...
INSERT INTO altdesk.Channel (ChannelId, TenantId, Type, Name) VALUES (@ch, @tenant, 'WHATSAPP', 'WhatsApp GTI');

INSERT INTO altdesk.ChannelConnector (ConnectorId, ChannelId, Provider, RoutingKey, ConfigJson, IsActive)
VALUES ('whatsapp-gti-dev', @ch, 'GTI', NULL, N'{"baseUrl":"","token":"","instance":""}', 1);

-- Respostas prontas exemplo
INSERT INTO altdesk.CannedResponse (TenantId, Title, Category, ChannelType, Shortcut, Content, Body)
VALUES
