...
INSERT INTO altdesk.ChannelConnector (ChannelId, Provider, RoutingKey, ConfigJson, IsActive)
VALUES (@ch, 'GTI', NULL, N'{"baseUrl":"","token":"","instance":""}', 1);

-- Respostas prontas exemplo
INSERT INTO altdesk.CannedResponse (TenantId, Title, Category, ChannelType, Body)
VALUES
